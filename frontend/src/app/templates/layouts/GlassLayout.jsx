                ...
                {u.email && (
                  <a href={`mailto:${u.email}`}
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.boxShadow = `0 12px 36px ${ac}60`;
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.transform = "none";
                      e.currentTarget.style.filter = "none";
                      e.currentTarget.style.boxShadow = `0 8px 32px ${ac}40`;
                    }}
                  >
                ...
                {u.phone && (
                  <a href={`tel:${u.phone}`}
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.boxShadow = `0 12px 36px ${ac}40`;
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.transform = "none";
                      e.currentTarget.style.background = "transparent";
                      e.currentTarget.style.boxShadow = `0 8px 32px ${ac}20`;
                    }}
                  >
