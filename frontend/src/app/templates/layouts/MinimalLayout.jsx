...
import { Soc, Tags, FAQList, SectionLabel, sn, VideoEmbed, MusicEmbed, GalleryAlbum, trackProjectClick, ScrollReveal } from "./shared.jsx";
                ...
                {u.email && (
                  <a 
                    ...
                    style={{ 
                      ...
                      textDecoration:"none", 
                      fontWeight:500,
                      boxShadow: `0 4px 14px -4px color-mix(in srgb, ${t.ac} 50%, transparent)`,
                      transition: "all 0.3s ease"
                    }}
                    onMouseEnter={(e) => {
                      e.currentTarget.style.transform = "translateY(-2px)";
                      e.currentTarget.style.filter = "brightness(1.08)";
                      e.currentTarget.style.boxShadow = `0 6px 20px -4px color-mix(in srgb, ${t.ac} 65%, transparent)`;
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.transform = "none";
                      e.currentTarget.style.filter = "none";
                      e.currentTarget.style.boxShadow = `0 4px 14px -4px color-mix(in srgb, ${t.ac} 50%, transparent)`;
                    }}
                  >
