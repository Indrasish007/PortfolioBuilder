            ...
            <div style={{ borderTop:border, paddingTop:40 }}>
              ...
              <div style={{ display:"flex", gap:16, flexWrap:"wrap" }}>
                {u.email && (
                  <a href={`mailto:${u.email}`}
                    style={{ display:"inline-flex", alignItems:"center", gap:10, padding:isMono?"12px 28px":"16px 40px",
                      ...
                      border: isMono ? "2px solid #111" : `3px solid ${ac}`,
                      transition: "transform 0.3s ease, box-shadow 0.3s ease"
                    }}
                    onMouseEnter={(e) => {
                      e.currentTarget.style.transform = "translate(-4px, -4px)";
                      e.currentTarget.style.boxShadow = isMono ? "4px 4px 0px #111" : `6px 6px 0px ${t.fg}`;
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.transform = "none";
                      e.currentTarget.style.boxShadow = "none";
                ...
                {u.phone && (
                  <a href={`tel:${u.phone}`}
                    style={{ display:"inline-flex", alignItems:"center", gap:10, padding:isMono?"12px 28px":"16px 40px",
                      background: "transparent", color: ac, border: isMono ? "2px solid #111" : `3px solid ${ac}`,
                      fontWeight:900, fontSize: isMono?13:16, textDecoration:"none",
                      fontFamily:"Inter,sans-serif", textTransform:isMono?"none":"uppercase", letterSpacing:isMono?"0":"0.1em",
                      transition: "transform 0.3s ease, box-shadow 0.3s ease"
                    }}
                    onMouseEnter={(e) => {
                      e.currentTarget.style.transform = "translate(-4px, -4px)";
                      e.currentTarget.style.boxShadow = isMono ? "4px 4px 0px #111" : `6px 6px 0px ${ac}`;
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.transform = "none";
                      e.currentTarget.style.boxShadow = "none";
